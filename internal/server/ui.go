...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> CHALKBOARD</h1>
...
<script>
var A='/api';
var RESOURCE='lessons';
var TITLE_FIELD='title';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "subject", "label": "Subject", "type": "text"}, {"name": "content", "label": "Content", "type": "textarea"}, {"name": "grade", "label": "Grade", "type": "text"}, {"name": "duration", "label": "Duration", "type": "integer"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "tags", "label": "Tags", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
